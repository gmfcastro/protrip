          ...
          <div class="row">
           ...
           <div class="col-md-6 pull-left">
               ...
               <p><div class="form-group">
                 ...
                 <div class="col-sm-10">
                   <input type="text" class="form-control" name="fromandto.name" value="${fromandto.name}" id="inputNameFromandto" placeholder="Nome">
                 </div>
               </div>
               <div class="form-group">
                 <label for="inputDescFromandto" class="col-sm-2 control-label">Descrição</label>
                 <div class="col-sm-10">
                   <textarea class="form-control" name="fromandto.description" id="inputDescFromandto" placeholder="Descrição" rows="3">${fromandto.description}</textarea>
                 </div>
               </div>
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                      <select class="form-control" name="countryId">
                       <c:forEach items="${countries}" var="country">
                           <c:if test="${country.id == fromandto.country.id}">
