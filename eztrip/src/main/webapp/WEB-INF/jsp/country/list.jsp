      ...
      <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 pull-right">
                    <a class='btn btn-lg btn-primary' href="<c:url value='/admin/country/add'/>" style="margin-top: 20px;">+ Novo País</a>
                </div>
            </div>
            <hr>
            ...
            <c:forEach items="${countries}" var="country">
                <tr>
                    ...
                    <td><a class='btn btn-primary' href='<c:url value="/admin/country/edit/${country.id}"/>'>Editar</a></td>
                    <td><a class='btn btn-danger' href='<c:url value="/admin/country/remove/${country.id}"/>'>Remover</a></td>
                </tr>
            </c:forEach>
            </table><br/>
        </div>
