      ...
      <div class="container">
          <div class="row">
           ...
           <div class="col-md-6 pull-left">
               <h1>Editar País</h1>
                <hr>
                <form class="form-horizontal" role="form" action="<c:url value='/admin/country/save'/>" method="POST">
                    <input type="text" name="country.id" value="${country.id}" hidden>
               <p><div class="form-group">
                 <label for="inputNameCountry" class="col-sm-2 control-label">Nome</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control" name="country.nameCountry" value="${country.nameCountry}" id="inputNameCountry" placeholder="Nome">
                 </div>
               </div>
                 ...
                 <div class="col-sm-10">
                      <select class="form-control" name="regionId">
                       <c:forEach items="${regions}" var="region">
                           <c:if test="${region.id == country.region.id}">
