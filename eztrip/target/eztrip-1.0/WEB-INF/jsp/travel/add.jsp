        ...
        <div class="container">
          <div class="row">
           ...
           <div class="col-md-6 pull-left">
               <h1>Nova Viagem</h1>
                <hr>
                <form class="form-horizontal" role="form" action="<c:url value='/travel/save'/>" method="POST">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                     <input type="date" pattern="dd/MM/yyyy" class="form-control" name="travel.dataIdaFormatada" id="inputDateGoFromandto" placeholder="Data ida">
                 </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-10">
                     <input type="date" pattern="dd/MM/yyyy" class="form-control" name="travel.dataVoltaFormatada" id="inputDateBackFromandto" placeholder="Data ida">
                 </div>
               </div>
               <div class="form-group">
